...
RUN apt-get install -y libaio-dev supervisor nano openssl libzip-dev unixodbc zip unzip git wget libfreetype6-dev libjpeg62-turbo-dev libpng-dev libldb-dev libldap2-dev unixodbc-dev
